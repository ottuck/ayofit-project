...
import {FastRecordView,RecordOneView,RecordUseTime,RecordSTime,RecordETime,
    RecordScrollView,RecordUnderC,RecordUpC,RecordRTime
        ...
        <FastRecordView>
          ...
          {fastData.map((data, index) => (
            <RecordOneView key={index}>
              <RecordUseTime style={{ fontFamily: 'OpenSans_600SemiBold_Italic' }}>Using Time : {formatTimeFromSeconds(data.elapsedTime)}</RecordUseTime>
